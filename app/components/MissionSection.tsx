      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className={`
            ...
            ${darkMode ? 'text-orange-400' : 'text-blue-900'}
          `}>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Mission Card */}
          <div className={`
            p-8 rounded-lg shadow-md border-t-4 border-orange-600 transition-colors duration-300
          ...
          `}>
            <div className="flex items-center mb-6">
              ...
              `}>
                <svg className={`w-8 h-8 transition-colors duration-300 ${darkMode ? 'text-orange-400' : 'text-orange-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Vision Card */}
          <div className={`
            p-8 rounded-lg shadow-md border-t-4 border-blue-900 transition-colors duration-300
            ${darkMode ? 'bg-gray-700' : 'bg-white'}
          `}>
            <div className="flex items-center mb-6">
              <div className={`
                ...
                ${darkMode ? 'bg-blue-900/30' : 'bg-blue-100'}
              `}>
                <svg className={`w-8 h-8 transition-colors duration-300 ${darkMode ? 'text-blue-400' : 'text-blue-900'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          `}>
            ...
            <ul className={`space-y-3 transition-colors duration-300 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
              <li className="flex items-start">
                <span className={`mr-2 mt-1 transition-colors duration-300 ${darkMode ? 'text-orange-400' : 'text-orange-600'}`}>•</span>
